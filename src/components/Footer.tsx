      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="font-mono text-[10px] uppercase tracking-[0.15em] text-neutral-600 max-w-xs leading-relaxed">
          ...
          {/* Navigation Column */}
          <div>
            <h4 className="font-label text-[10px] uppercase tracking-[0.2em] text-outline mb-6">
              Navigation
            </h4>
            <ul className="space-y-4">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="font-mono text-[11px] uppercase tracking-[0.15em] text-neutral-600 hover:text-primary-container transition-colors duration-300"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="mt-16 pt-8 border-t border-neutral-900 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="font-label text-[10px] uppercase tracking-[0.2em] text-neutral-700">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[10px] text-primary-fixed-dim uppercase tracking-widest">
              Systems Online
            </span>
          </div>
        </div>
